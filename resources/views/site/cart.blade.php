                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="cart">
                                ...
                                <h1 class="cart-title">In Your Shopping Cart: <span class="c-primary">
                                        {{ session('cart') ? count(session('cart')) : 0 }} items</span></h1>
                            ...
                            @if (session('cart'))
                                                    ...
                                                    <td class="product-quantity">
                                                        ...
                                                        <div class="quantity">
                                                            ...
                                                            <input title="Qty" class="email input-text qty text"
                                                                type="text" placeholder="1" readonly
                                ...
                                <div class="cart-total">
                                    ...
                                    <h5 class="cart-total-total">Total: <span
                                            class="price">{{ config('product.currency') }}{{ $cartTotal }}</span>
                                    </h5>
